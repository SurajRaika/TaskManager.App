...
export const useTodoStore = defineStore({
  ...
  state: () => ({
    TodoData: JSON.parse(localStorage.getItem("Todo_LocalData")) || {
      ...
      TodoList: [
        {Title:'CheckOut Full Application',Category:'courier 🧐',description:'I have To Check Out This Website So that I can Find out Skill OF Developer.',start_time:new Date().getTime() - 10000 ,end_time:new Date().getTime() + 600000 , completed:false }
       , {Title:'Try Application for 2 days',Category:'Testing 🧐',description:'Check Out web app If It is Good For Every Day Life',start_time:new Date().getTime() - 100000 ,end_time:new Date().getTime() + 2200000 , completed:false }
